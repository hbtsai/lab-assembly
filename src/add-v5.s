@ ***********************************************************************
@ *									*
@ *	 Add Two Numbers (Version 5 of the Assembly Language Code)	*
@ *									*
@ ***********************************************************************
...
@ stores the result back in memory.  This version uses the ADR pseudo-
@ instruction.
...
main:					@ Entry to the function "main"
	...
	adr	r3, a			@ R3 = Address of "a"
	ldr	r1, [r3]		@ R1 = 10 (from "a")

	adr	r3, b			@ R3 = Address of "b"
	ldr	r2, [r3]		@ R2 = 11 (from "b")

	add	r0, r1, r2		@ R0 = a + b = 21

	adr	r3, c			@ R3 = Address of "c"
